...
exports.GitHubAPI = exports.Octokit = exports.Application = exports.Context = exports.Logger = exports.createProbot = exports.Probot = void 0;
...
var Probot = /** @class */ (function () {
    ...
    Probot.prototype.start = function () {
        var _this = this;
        return this.httpServer = this.server.listen(this.options.port, function () {
            if (_this.options.webhookProxy) {
                webhook_proxy_1.createWebhookProxy({
                    logger: logger_1.logger,
                    path: _this.options.webhookPath,
                    port: _this.options.port,
                    url: _this.options.webhookProxy
                });
            }
            logger_1.logger.info('Listening on http://localhost:' + _this.options.port);
        }).on('error', function (err) {
            if (err.code === 'EADDRINUSE') {
                logger_1.logger.error("Port " + _this.options.port + " is already in use. You can define the PORT environment variable to use a different port.");
            }
            else {
                logger_1.logger.error(err);
            }
